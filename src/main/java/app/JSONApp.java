...
public class JSONApp {
    ...
    public static JsonObject sessionResult() {
        ...
        // ToDo
        Student andriiRodionov = new Student("Andrii", "Rodionov", 2, new Tuple<String, Integer>("OOP", 3), new Tuple<String, Integer>("English", 5), new Tuple<String, Integer>("Math", 2));
        jsonObject = andriiRodionov.toJsonObject();
        return jsonObject;
    }
}
